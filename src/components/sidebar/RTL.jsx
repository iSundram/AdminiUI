  ...
  return (
    <>
      ...
      >
        ...
        {/* Customizer Button */}
        <button
          className="absolute top-4 start-4 block cursor-pointer p-2 rounded-lg bg-white/20 hover:bg-white/30 transition-all"
      ...
      {/* Customizer Panel */}
      {showCustomizer && (
        <div className="fixed top-0 left-0 h-full w-80 bg-white/95 backdrop-blur-md shadow-2xl z-[60] transition-all duration-300 dark:bg-navy-800/95">
          <div className="p-6">
